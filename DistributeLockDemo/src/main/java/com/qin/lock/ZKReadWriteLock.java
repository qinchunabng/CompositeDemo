...
//    private WriteLock writeLock;
    ...
    public ZKReadWriteLock(String connectString) throws IOException, InterruptedException {
        zooKeeper = new ZooKeeper(connectString, 1000, watchedEvent -> {
...
//        private String prefix = new Random().nextInt(10000000) + "-read-";
        ...
        public boolean tryLock(long millisecond) throws Exception {
            ...
            for (; ; ) {
                ...
                //线程休眠，避免浪费CPU资源
                if (millisecond < 0 || millisecond > SPIN_FOR_TIMEOUT_THRESHOLD) {
